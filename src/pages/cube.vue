<template>
  <div class="relative flex flex-1 justify-center items-center bg-radial from-40% from-zinc-200 to-zinc-300 drop-shadow-md md:drop-shadow-none rounded-lg md:rounded-none size-full">
